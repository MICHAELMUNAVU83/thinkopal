    ...
    >
      <div className="w-[90%] mx-auto flex justify-between p-8">
        ...
        <div className="flex flex-col justify-around items-end">
          ...
          <p className="w-[90%] text-5xl quicksand-700 font-bold text-end">Step by Step Guide on CrowdFunding Your Small Business</p>

          <p className="text-black bg-white py-2 px-4 cursor-pointer font-semibold quicksand-700 rounded-lg ">Download Free Guide</p>
